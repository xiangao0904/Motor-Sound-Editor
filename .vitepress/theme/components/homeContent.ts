...
const installerUrl =
  "https://github.com/xiangao0904/Motor-Sound-Editor/releases";
const featureIcons = {
...
export const homeContent: Record<HomeLocale, HomeContent> = {
  en: {
    ...
    brandSubline: "BVE and openBVE Train Sound Editor",
    ...
    hero: {
      ...
      lead: "A dedicated BVE and openBVE motor sound editor for building train sound projects with VVVF-style curve control, real-time preview, and export-ready packaging.",
      primaryAction: "Download for Windows & macOS",
    ...
    features: {
      ...
      lead: "Every feature is designed to streamline the transition from raw samples to a functional BVE motor sound package and reusable train sound project.",
      items: [
        {
    ...
    showcase: {
      ...
      lead: "From project management to detailed curve editing, the workspace is optimized for BVE motor sound authoring and openBVE train sound workflow review.",
      cards: [
        {
          ...
          src: "/homepage.png",
          alt: "Motor Sound Editor project gallery for BVE and openBVE train sound projects",
        },
        {
          ...
          src: "/editpage.png",
          alt: "Motor Sound Editor editor workspace for BVE motor sound and VVVF curve editing",
        },
      ],
    },
    workflow: {
    ...
    docs: {
      ...
      lead: "Everything you need to master the Motor Sound Editor workflow, from BVE train sound setup to openBVE export and advanced motor sound editing.",
      action: "Open Docs",
      cards: [
        {
          title: "Getting Started",
          copy: "Installation guide and a walkthrough for your first BVE motor sound editor project.",
          href: "/docs/guide/getting-started",
          cta: "Read Guide",
        },
        {
          title: "Editor Guide",
          copy: "In-depth explanation of curve editing, track layering, and state management for train sound editor work.",
          href: "/docs/guide/editor",
          cta: "Read Guide",
        },
        {
          title: "Export Pipeline",
          copy: "Technical details on project packaging, export flow, and BVE compatibility.",
    ...
    finalCta: {
      ...
      copy: "Download the latest release for Windows or macOS, or explore the documentation to learn more.",
      primaryAction: "Download for Windows & macOS",
  ...
  zh: {
    ...
    githubLabel: "GitHub",
    versionLabel: "最新版本",
    brandSubline: "面向 BVE 与 openBVE 的列车音效编辑器",
    frameContext: "工作区预览",
    showcaseAriaLabel: "软件界面预览",
    hero: {
      kicker: "BVE 电机音效可视化创作工作流",
      titleLines: ["以直观的", "可视化方式", "设计 BVE 电机音效。"],
      lead: "专为 BVE 与 openBVE 电机音效项目打造的桌面编辑器，适合进行 VVVF 风格曲线设计、实时试听和导出打包。",
      primaryAction: "下载 Windows / macOS 版",
    ...
    features: {
      ...
      lead: "每一项功能都旨在简化从原始素材到 BVE 电机音效包、openBVE 列车音效项目的转化过程。",
      items: [
        {
          icon: featureIcons.curve,
          title: "可视化曲线编辑器",
    ...
    showcase: {
      ...
      lead: "从项目管理到细节化曲线调校，工作区布局均针对 BVE 电机音效与列车音效编辑流程进行了深度优化。",
      cards: [
        {
          label: "项目画廊",
          title: "集中化管理",
          ...
          src: "/homepage.png",
          alt: "Motor Sound Editor 中用于管理 BVE 与 openBVE 列车音效项目的首页画廊",
        },
        {
          label: "编辑器工作区",
          title: "精准控制",
          ...
          src: "/editpage.png",
          alt: "Motor Sound Editor 中用于编辑 BVE 电机音效曲线的工作区界面",
        },
      ],
    },
    workflow: {
    ...
    docs: {
      ...
      lead: "从环境搭建到高级导出配置，提供覆盖 BVE、电机音效和 openBVE 列车音效编辑的完整指南。",
      action: "打开文档",
      cards: [
        {
          title: "快速入门",
          copy: "安装指南及首个 BVE 电机音效项目的新手引导。",
          href: "/zh/docs/guide/getting-started",
          cta: "阅读指南",
        },
        {
          title: "编辑器指南",
          copy: "深度解析曲线编辑、音轨分层及列车状态管理等核心功能。",
          href: "/zh/docs/guide/editor",
          cta: "阅读指南",
        },
        {
          title: "导出管线",
          copy: "关于项目封装规范、导出流程及 BVE 兼容性的技术细节说明。",
    ...
    finalCta: {
      ...
      copy: "下载 Windows 或 macOS 最新版本，也可以查阅文档了解更多信息。",
      primaryAction: "下载 Windows / macOS 版",
